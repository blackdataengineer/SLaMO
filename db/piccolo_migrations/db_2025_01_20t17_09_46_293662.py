...
async def forwards():
    ...
    manager.add_table(
        class_name="JobSkill", tablename="job_skills", schema=None, columns=None
    )

    manager.add_column(
        table_class_name="JobSkill",
